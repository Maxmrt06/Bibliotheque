...
class LivresController{
    ...
    public function ajoutLivreValidation(){
        ...
        $this->livreManager->ajoutLivreBd($_POST['titre'],$_POST['auteur'],$_POST['resume'],$_POST['nbPages'],$nomImageAjoute);

        $_SESSION['alert'] = [
        "type" => "success",
        "msg" => "Votre livre a bien été ajouté"
        ];
    ...
    public function suppressionLivre($id){
        ...
        $_SESSION['alert'] = [
        "type" => "success",
        "msg" => "Votre livre a bien été supprimé"
        ];
    ...
    public function modificationLivreValidation(){
        ...
        $this->livreManager->modificationLivreBD($_POST['identifiant'],$_POST['titre'],$_POST['auteur'],$_POST['resume'],$_POST['nbPages'],$nomImageToAdd);

        $_SESSION['alert'] = [
        "type" => "success",
        "msg" => "Votre livre a bien été modifié"
        ];
